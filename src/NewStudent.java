...
public class NewStudent extends javax.swing.JFrame {
    ...
    public NewStudent() {
        super("New Student Registration");
        initComponents();
        conn=JavaConnect.connectDB();
        rd=new Random();
        code = rd.nextInt(900)+100;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 153, 51), 2, true), "Student Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 102, 51))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.SC", "B.COM", "BA", "BBA", "BCA", "M.SC", "M.COM", "MCA" }));
