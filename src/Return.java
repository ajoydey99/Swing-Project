...
public class Return extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 51), 2), "Return Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 102, 102))); // NOI18N
    ...
    public void deleteIssue()
    {
        try
        {
            String query="DELETE FROM Issue WHERE StudentID=?";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            String query="SELECT * FROM Book JOIN Issue ON Issue.BookID=Book.id WHERE StudentID="+id;
            pst=conn.prepareStatement(query);
            rs=pst.executeQuery();
            if(rs.next())
            {
            ...
            {
                JOptionPane.showMessageDialog(null,"Book not issued with this ID");
            }
        }
        catch(Exception e)
        {
